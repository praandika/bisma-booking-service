        ...
        <div class="box-body">
          <div class="row">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group has-feedback">
                      <input type="text" class="form-control" id="datepicker1" name="awal" placeholder="Pilih Tanggal" readonly="readonly" value="{{ $tgl }}" value="{{ old('awal') }}">
                      <span class="fa fa-calendar form-control-feedback"></span>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group has-feedback">
                      <input type="text" class="form-control" id="datepicker2" name="akhir" placeholder="Pilih Tanggal" readonly="readonly" value="{{ $tgl }}" value="{{ old('akhir') }}">
                      <span class="fa fa-calendar form-control-feedback"></span>
                    </div>
                  </div>
                  <div class="col-md-2">
            ...
            <div class="col-md-6" align="right">
              <a href="{{ URL('admin/excel') }}" class="btn btn-flat btn-success"><i class="fa fa-file-excel-o"></i> Export Excel</a>
            </div>
          </div>
