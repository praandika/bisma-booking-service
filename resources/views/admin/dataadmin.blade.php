...
<div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <button class="btn btn-success" data-toggle="modal" data-target="#myData"><i class="fa fa-plus"></i> Tambah</button><br><br>
          <div class="table-responsive">
        	<table id="myTable" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                	...
                	<td>{{ $o->akses }}</td>
                  <td>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#myEdit{{ $o->id }}"><i class="fa fa-pencil"></i></button>
                    <button class="btn btn-warning" data-toggle="modal" data-target="#myPass{{ $o->id }}"><i class="fa fa-lock"></i></button>
                    <a href="{{URL('admin/delete',$o->id)}}" class="btn btn-danger" onclick="return tanya('Yakin hapus data {{ $o->username }}?')"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                @endforeach
                </tbody>
